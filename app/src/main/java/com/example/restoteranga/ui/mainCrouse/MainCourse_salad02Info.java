...
public class MainCourse_salad02Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_course_salad02_info);
        ...
        return_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainCourse_salad02Info.this, MainCrouse.class);
                startActivity(i);
            }
        });
        ...
        commander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainCourse_salad02Info.this, Connexion.class);
                startActivity(i);
            }
        });
    }
