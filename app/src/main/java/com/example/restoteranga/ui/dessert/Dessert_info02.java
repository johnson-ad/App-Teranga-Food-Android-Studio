...
public class Dessert_info02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dessert_info02);
        ...
        return_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Dessert_info02.this, Dessert.class);
                startActivity(i);
            }
        });
        ...
        commander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Dessert_info02.this, Connexion.class);
                startActivity(i);
            }
        });
    }
