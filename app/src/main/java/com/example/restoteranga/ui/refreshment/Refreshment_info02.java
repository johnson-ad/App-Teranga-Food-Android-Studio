...
public class Refreshment_info02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refreshment_info02);
        ...
        return_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Refreshment_info02.this, Refreshment.class);
                startActivity(i);
            }
        });
        ...
        commander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Refreshment_info02.this, Connexion.class);
                startActivity(i);
            }
        });
    }
