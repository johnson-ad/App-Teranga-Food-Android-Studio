...
public class MainCourse_salad05Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_course_salad05_info);
        ...
        return_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainCourse_salad05Info.this, MainCrouse.class);
                startActivity(i);
            }
        });
        ...
        commander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainCourse_salad05Info.this, Connexion.class);
                startActivity(i);
            }
        });
    }
