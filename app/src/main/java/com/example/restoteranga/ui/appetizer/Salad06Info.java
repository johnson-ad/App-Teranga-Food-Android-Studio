...
public class Salad06Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salad06_info);
        ...
        return_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Salad06Info.this, AppetizerActivity.class);
                startActivity(i);
            }
        });
        ...
        commander.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Salad06Info.this, Connexion.class);
                startActivity(i);
            }
        });
    }
